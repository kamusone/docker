...
# then remove local image from cache (docker images purge)
# then start a new container from your Hub image, and watch how it auto downloads and runs
# test again that it works at http://localhost


# Instructions from the app developer
# - you should use the 'node' official image, with the alpine 6.x branch (check dockerhub)
...
# - to keep it clean and small, run 'npm cache clean --force' after above and on the same line
